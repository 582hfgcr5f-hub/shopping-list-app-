...
setTimeout(()=>{
 ...
 const style=document.createElement('style');style.textContent=`#home .card:has(#cal){overflow:hidden}.cal{width:100%;min-width:0;grid-template-columns:repeat(7,minmax(0,1fr))!important}.cal>*{min-width:0;max-width:100%;box-sizing:border-box}.date{width:100%;min-width:0;max-width:100%;overflow:hidden;text-align:center}.date .evt{max-width:100%;overflow-wrap:break-word;word-break:normal;hyphens:auto}@media(max-width:430px){#home .card:has(#cal){padding-left:8px;padding-right:8px}.cal{gap:3px!important}.dow{font-size:10px}.date{padding:4px 1px!important;min-height:68px}.date .n{font-size:12px}.date .evt{font-size:7px!important;line-height:1.05;margin-top:3px}}`;document.head.appendChild(style);
 ...
 renderMonth();if(typeof renderSuppers==='function')renderSuppers();
},0);
